...
def test_create_transmission_loss(client: TestClient, normal_user_headers: Dict[str, str], db: Session):
    """
    Test creating a transmission loss.
    """
    create_request = data_generator.fixed_transmission_loss_create(db)
...
def test_create_existing_transmission_loss(client: TestClient, normal_user_headers: Dict[str, str], db: Session):
    """
...
def test_create_transmission_loss_unknown_dataset(client: TestClient, normal_user_headers: Dict[str, str], db: Session):
    """
...
def test_create_transmission_loss_unknown_component(client: TestClient, normal_user_headers: Dict[str, str], db: Session):
    """
...
def test_create_transmission_loss_unknown_regions(client: TestClient, normal_user_headers: Dict[str, str], db: Session):
    """
...
def test_get_all_transmission_losses(client: TestClient, normal_user_headers: Dict[str, str], db: Session):
    """
...
def test_get_transmission_loss(client: TestClient, normal_user_headers: Dict[str, str], db: Session):
    """
    Test retrieving a transmission loss.
    """
    existing_loss = data_generator.fixed_existing_transmission_loss(db)
...
def test_get_transmission_losses_by_component(client: TestClient, normal_user_headers: Dict[str, str], db: Session):
    """
...
def test_remove_transmission_losses_by_component(client: TestClient, normal_user_headers: Dict[str, str], db: Session):
    """
