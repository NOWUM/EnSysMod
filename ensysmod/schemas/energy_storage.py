...
class EnergyStorageBase(BaseModel):
    ...
    charge_efficiency: float | None = Field(None, description="The efficiency of charging the storage.", example=0.9)
    discharge_efficiency: float | None = Field(None, description="The efficiency of discharging the storage.", example=0.9)
    self_discharge: float | None = Field(None, description="The self-discharge of the storage.", example=0.00009)
    cyclic_lifetime: int | None = Field(None, description="The cyclic lifetime of the storage.", example=100)
    charge_rate: float | None = Field(None, description="The charge rate of the storage.", example=0.3)
    discharge_rate: float | None = Field(None, description="The discharge rate of the storage.", example=0.2)
    state_of_charge_min: float | None = Field(None, description="The minimum state of charge of the storage.", example=0.1)
    state_of_charge_max: float | None = Field(None, description="The maximum state of charge of the storage.", example=0.9)
...
class EnergyStorageCreate(EnergyStorageBase, EnergyComponentCreate):
    ...
    commodity: str = Field(..., description="Commodity to be stored in the energy storage.", example="electricity")
